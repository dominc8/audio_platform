...
SHARED(volatile bm_meas fir_measurements_f32[36]);
SHARED(volatile bm_meas fir_measurements_i32[36]);
SHARED(volatile bm_meas fir_measurements_q31[36]);
SHARED(volatile bm_meas fir_measurements_custom[6]);
